...
public class dashboardController implements Initializable {
    ...
    public void addStudentsInsertImage() {
        ...
        if (file != null) {
            // Getting the file path in a normalized format
            String filePath = file.toURI().toString();

            // Creating an image object
            Image image = new Image(filePath, 120, 149, false, true);
            addStudents_imageView.setImage(image);

            // If you need to store the file path (absolute path) somewhere
            getData.path = file.getAbsolutePath();getData.path = file.getAbsolutePath();
...
//        WE NEED TO FIX THE DELETE ON ADD STUDENT FORM
    ...
    public void defaultNav(){
        home_btn.setStyle("-fx-background-color: linear-gradient(to top, #F2075D, #9B0038, #000000);");
    }
    ...
    public void switchForm(ActionEvent event) {
        if (event.getSource() == home_btn) {
            ...
            addStudents_btn.setStyle("-fx-background-color: linear-gradient(to top, #F2075D, #9B0038, #000000);");
...
//            TO BECOME UPDATED ONCE YOU CLICK THE ADD STUDENTS BUTTON ON NAV
            ...
            availableCourse_btn.setStyle("-fx-background-color: linear-gradient(to top, #F2075D, #9B0038, #000000);");
            addStudents_btn.setStyle("-fx-background-color:transparent");
            home_btn.setStyle("-fx-background-color:transparent");
            studentGrade_btn.setStyle("-fx-background-color:transparent");
            ...
            studentGrade_btn.setStyle("-fx-background-color: linear-gradient(to top, #F2075D, #9B0038, #000000);");
            addStudents_btn.setStyle("-fx-background-color:transparent");
            availableCourse_btn.setStyle("-fx-background-color:transparent");
            home_btn.setStyle("-fx-background-color:transparent");
